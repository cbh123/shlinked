defmodule ShlinkedinWeb.PostLive.PostComponent do
  ...
  def handle_event("pin-post", _params, socket) when socket.assigns.profile.admin do
  ...
  def handle_event("unpin-post", _params, socket) when socket.assigns.profile.admin do
    post = Timeline.get_post!(socket.assigns.post.id)
  ...
  def handle_event("feature-post", _params, socket) when socket.assigns.profile.admin do
    post = Timeline.get_post!(socket.assigns.post.id)
  ...
  def handle_event("unfeature-post", _, socket) when socket.assigns.profile.admin do
    post = Timeline.get_post!(socket.assigns.post.id)
